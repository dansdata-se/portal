...
class SupabaseAuthService extends AuthService {
  SupabaseAuthService._(this._logger, this._supabase);

  final Logger _logger;
  final Supabase _supabase;

  static bool _didInitSupabase = false;

  static Future<SupabaseAuthService> create(Logger logger) async {
    // Supabase.initialize must only be called once - or an AssertionError is
    // thrown.
    final supabase = _didInitSupabase
        ? Supabase.instance
    ...
    return SupabaseAuthService._(logger, supabase);
  }
